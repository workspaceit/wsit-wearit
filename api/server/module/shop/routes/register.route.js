...
// const regsterShop = multer.diskStorage({
//   destination(req, file, cb) {
//     cb(null, config.documentDir);
//   },
...
module.exports = (router) => {
  ...
  router.post(
    ...
    uploadDocument.fields([
      ...
      { name: 'eTin', maxCount: 1 },
      { name: 'bankDetails', maxCount: 1 },
      { name: 'businessDetails', maxCount: 1 },
      { name: 'storeDetails', maxCount: 1 }
    ]),
  ...
  //     { name: 'storeDetails', maxCount: 1 }
  //   ]),
  //   registerController.shopRegister,
  //   Middleware.Response.success('register')
  // );
};
